...
exp_param.tgt_reps = [3, 3, 3, 3, 3, 3, 3, 3, 3, 3, 3, 3];
...
nT_total = nC_washout; % Total number of trials
...
Trial.washout(1) = 1;
Trial.washout(2) = nC_washout; % block 4
...
% Movement target.
T.tgt_location = ones(nT_total, 1); T.tgt_location(Trial.washout(1):Trial.washout(2)) = all_trials(:, 1);
