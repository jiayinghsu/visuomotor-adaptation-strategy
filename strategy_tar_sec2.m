...
exp_param.tgt_reps = [25, 25, 25, 25, 25, 25, 25, 25, 25, 25, 25, 25];
...
nT_total = nC_rotation; % Total number of trials
...
% Movement target.
T.tgt_location = ones(nT_total, 1); T.tgt_location(Trial.rotation(1):Trial.rotation(2)) = all_trials(:, 1);
